...
def main(page: ft.Page):
    ...
    #capturar a altura e largura da pagina do aplicativo
    ...
    # adição do scroll: para manter o tamanho da tela e adicionar uma barra de rolagem
    listas_task_coluna = ft.Column(height=HEIGHT-170, scroll=ft.ScrollMode.ADAPTIVE)
